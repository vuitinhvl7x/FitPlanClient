      ...
      <div className="w-full max-w-2xl">
        ...
        <Card className="w-full bg-[#2A2A2A] border-[#333333]">
          <CardHeader>
            ...
            <CardDescription className="text-gray-400">Step {step} of 3</CardDescription>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              {step === 1 && (
                <div className="space-y-6">
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-200">What is your activity level?</label>
                    <Select
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-200">What is your fitness experience level?</label>
                    <Select
              ...
              {step === 2 && (
                <div className="space-y-6">
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-200">Where do you plan to train?</label>
                    <Select
                      onValueChange={(value) => setProfile({ ...profile, training_location: value })}
                          ...
                          <Checkbox
                            ...
                            onCheckedChange={(checked) => {
                              if (checked) {
                                setProfile({
                                  ...profile,
                                  preferred_training_days: [...profile.preferred_training_days, day],
                                })
                              } else {
                                setProfile({
                                  ...profile,
                                  preferred_training_days: profile.preferred_training_days.filter((d) => d !== day),
                                })
                              }
                            }}
                            className="border-[#FF3366] data-[state=checked]:bg-[#FF3366]"
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="pre_workout_info"
                      onCheckedChange={(checked) => setProfile({ ...profile, wants_pre_workout_info: !!checked })}
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="pt-6 pb-2">
                      <Slider defaultValue={[3]} max={7} min={1} step={1} className="[&_[role=slider]]:bg-[#FF3366]" />
              ...
              <div className="flex justify-between pt-4">
                ...
                {step < 3 ? (
                  <Button type="button" onClick={handleNext} className="bg-[#FF3366] hover:bg-opacity-90">
                    Next
                  </Button>
                ) : (
                  <Button type="submit" className="bg-[#FF3366] hover:bg-opacity-90">
                    Complete Setup
                  </Button>
                )}
              </div>
