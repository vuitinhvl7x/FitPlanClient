        ...
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-6">
            <div className="w-full md:w-1/3 flex flex-col items-center">
              ...
              <p className="text-sm text-gray-400 mb-6">Member since {userData.joinDate}</p>

              {!editMode ? (
                <Button onClick={() => setEditMode(true)} className="bg-[#FF3366] hover:bg-opacity-90 w-full">
                  Edit Profile
                </Button>
              ) : (
                <div className="flex gap-2 w-full">
                  ...
                  <Button onClick={handleSave} className="bg-[#FF3366] hover:bg-opacity-90 flex-1">
                    Save
                  </Button>
                </div>
              )}
            ...
            <div className="w-full md:w-2/3">
              <Tabs defaultValue="personal" className="w-full" onValueChange={setActiveTab}>
                <TabsList className="bg-[#2A2A2A] p-1 w-full">
                  <TabsTrigger value="personal" className="flex-1 data-[state=active]:bg-[#FF3366]">
                    Personal Info
                  </TabsTrigger>
                  <TabsTrigger value="fitness" className="flex-1 data-[state=active]:bg-[#FF3366]">
                    Fitness Profile
                  </TabsTrigger>
                  <TabsTrigger value="preferences" className="flex-1 data-[state=active]:bg-[#FF3366]">
                    Preferences
                  </TabsTrigger>
                </TabsList>
                  ...
                  <div className="bg-[#2A2A2A] rounded-xl p-6">
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <label className="text-sm font-medium text-gray-200" htmlFor="weight">
                            Weight (kg)
                          </label>
                          {editMode ? (
                            <Input
                              ...
                              onChange={(e) =>
                                setFormData({
                                  ...formData,
                                  profile: { ...formData.profile, weight: Number(e.target.value) },
                                })
                              }
                              className="bg-[#333333] border-[#444444] text-white"
                            />
                          ) : (
                            <p className="text-gray-300">{userData.profile.weight} kg</p>
                          )}
                        </div>

                        <div className="space-y-2">
                          <label className="text-sm font-medium text-gray-200" htmlFor="height">
                            Height (cm)
                          </label>
                          {editMode ? (
                            <Input
                            ...
                            <p className="text-gray-300">{userData.profile.height} cm</p>
                          )}
                        </div>
                      </div>
                        ...
                        {editMode ? (
                          <Select
                            ...
                            onValueChange={(value) =>
                              setFormData({
                                ...formData,
                                profile: { ...formData.profile, activity_level: value },
                              })
                            }
                          >
                        ...
                        {editMode ? (
                          <Select
                            ...
                            onValueChange={(value) =>
                              setFormData({
                                ...formData,
                                profile: { ...formData.profile, experience: value },
                              })
                            }
                          >
                            <SelectTrigger className="bg-[#333333] border-[#444444] text-white">
                          ...
                          <p className="text-gray-300 capitalize">{userData.profile.experience}</p>
                        )}
                      </div>

                      <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-200">Fitness Goals</label>
                        {editMode ? (
                            ...
                            <div className="space-y-2">
                              {[
                                ...
                                <div key={goal} className="flex items-center space-x-2">
                                    ...
                                    onChange={(e) => {
                                      if (e.target.checked) {
                                        setFormData({
                                          ...
                                          profile: {
                                            ...formData.profile,
                                            goals: [...formData.profile.goals, goal],
                                          },
                                        })
                                      } else {
                                        setFormData({
                                          ...
                                          profile: {
                                            ...formData.profile,
                                            goals: formData.profile.goals.filter((g) => g !== goal),
                                          },
                                        })
                                      }
                                    }}
                                  ...
                                  />
                                  <label htmlFor={goal.toLowerCase().replace(" ", "_")} className="text-gray-200">
                                    {goal}
                                  </label>
                                </div>
                              ))}
                          ...
                          <div className="flex flex-wrap gap-2">
                            {userData.profile.goals.map((goal) => (
                              <span key={goal} className="text-sm bg-[#333333] px-3 py-1 rounded-full">
                                {goal}
                              </span>
                            ))}
                          </div>
                ...
                <TabsContent value="preferences" className="mt-4">
                  <div className="bg-[#2A2A2A] rounded-xl p-6">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-200">Training Location</label>
                        {editMode ? (
                          <Select
                            ...
                            onValueChange={(value) =>
                              setFormData({
                                ...formData,
                                profile: { ...formData.profile, training_location: value },
                              })
                            }
                          >
                            <SelectTrigger className="bg-[#333333] border-[#444444] text-white">
                          ...
                          <p className="text-gray-300 capitalize">{userData.profile.training_location}</p>
                        )}
                      </div>

                      <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-200">Preferred Training Days</label>
                        {editMode ? (
                          <div className="bg-[#333333] border border-[#444444] rounded-md p-3">
                            <div className="space-y-2">
                                ...
                                (day) => (
                                  <div key={day} className="flex items-center space-x-2">
                                    <input
                                      type="checkbox"
                                      id={day.toLowerCase()}
                                      checked={formData.profile.preferred_training_days.includes(day)}
                                      onChange={(e) => {
                                        if (e.target.checked) {
                                          setFormData({
                                            ...formData,
                                            profile: {
                                              ...
                                              preferred_training_days: [
                                                ...formData.profile.preferred_training_days,
                                                day,
                                              ],
                                            },
                                          })
                                          ...
                                          setFormData({
                                            ...
                                            profile: {
                                              ...formData.profile,
                                              preferred_training_days: formData.profile.preferred_training_days.filter(
                                                (d) => d !== day,
                                              ),
                                            },
                                          })
                                      ...
                                      className="rounded border-[#FF3366] text-[#FF3366] focus:ring-[#FF3366]"
                                    />
                                    <label htmlFor={day.toLowerCase()} className="text-gray-200">
                                      {day}
                                    </label>
                                  </div>
                                ),
                          ...
                          <div className="flex flex-wrap gap-2">
                            {userData.profile.preferred_training_days.map((day) => (
                              <span key={day} className="text-sm bg-[#333333] px-3 py-1 rounded-full">
                                {day}
                              </span>
                            ))}
                          </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-gray-400">Get tips and information before your workouts</p>
                        </div>
                        {editMode ? (
                          <Switch
                            id="pre_workout_info"
                            ...
                            onCheckedChange={(checked) =>
                              setFormData({
                                ...formData,
                                profile: { ...formData.profile, wants_pre_workout_info: checked },
                              })
                            }
                          ...
                          <span className="text-sm bg-[#333333] px-3 py-1 rounded-full">
                            {userData.profile.wants_pre_workout_info ? "Enabled" : "Disabled"}
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-gray-400">Use dark theme for the app</p>
                        </div>
                        <Switch
                          id="dark_mode"
                          checked={true}
